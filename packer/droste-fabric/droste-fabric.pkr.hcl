...
build {
  ...
  # use_backing_file produces an overlay on yarn (only changed blocks).
  ...
  post-processor "shell-local" {
    inline = [
      ...
      "qemu-img convert -O qcow2 -c -B ../output-droste-yarn/droste-yarn.qcow2 -F qcow2 ../../output-droste-fabric/droste-fabric.qcow2 ../../output-droste-fabric/droste-fabric-diff.qcow2",
      "qemu-img rebase -u -b droste-yarn.qcow2 -F qcow2 ../../output-droste-fabric/droste-fabric-diff.qcow2",
      # Standalone image: flatten overlay into self-contained image
      "qemu-img convert -O qcow2 -c ../../output-droste-fabric/droste-fabric.qcow2 ../../output-droste-fabric/droste-fabric-standalone.qcow2",
      # Replace raw overlay with standalone
      "mv ../../output-droste-fabric/droste-fabric-standalone.qcow2 ../../output-droste-fabric/droste-fabric.qcow2",
    ]
  }
}
